...
class GCN600(torch.nn.Module):
    def __init__(self, dataset):
        super(GCN600, self).__init__()
        self.conv1 = GCNConv(dataset.num_features, 48)
        self.conv_ = GCNConv(48, 48)
        self.conv__ = GCNConv(48, 48)
        ...
        self.fc = nn.Linear(600*4, 4)  # 300*4
